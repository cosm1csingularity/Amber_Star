...
import com.incaseofmagicx.amberstar.Constants.Campaign2
import com.incaseofmagicx.amberstar.Constants.Campaign3
...
class WebView : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        view1 = findViewById(R.id.ASview)
    ...
    private fun getUrl(): String {
        ...
        val dpOne: String? = Hawk.get(Deeplink1)
        val dpTwo: String? = Hawk.get(Deeplink2)
        val dpThree: String? = Hawk.get(Deeplink3)


        val pack = "com.incaseofmagicx.amberstar"
        ...
        val first = "https://"
        val second = "amberstar.site/r67Yu"
